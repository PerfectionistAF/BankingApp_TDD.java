...
public class DEPOSIT_UI extends javax.swing.JFrame {
     ...
     */
    public DEPOSIT_UI(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        setSize(409 , 200);
    }
    public DEPOSIT_UI(java.awt.Frame parent, boolean modal,int AccNum) {
        //super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        setSize(409 , 100);
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Deposit Amount");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Deposit value = "+ amount);
 
        ArrayList accounts;
        try {
            accounts = UserAccount.fileLoad2();
            useraccount = (UserAccount)accounts.get(AccNum-1);
            useraccount.depositTransaction(amount);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(WITHDRAW_UI.class.getName()).log(Level.SEVERE, null, ex);
        } catch (UnsupportedEncodingException ex) {
            Logger.getLogger(WITHDRAW_UI.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(DEPOSIT_UI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DEPOSIT_UI dialog = new DEPOSIT_UI(new javax.swing.JFrame(), true);
